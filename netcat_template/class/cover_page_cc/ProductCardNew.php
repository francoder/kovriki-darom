...
class ProductCard
{
    ...
    { ?>
			...
			<div class="kovriki--new-main-color">
				<p>Основной цвет коврика:</p>
				<div class="list-colors-of-pugs">
					<div data-num="1" class="red"></div>
					<div data-num="2" class="orange"></div>
					<div class="green"></div>
					<div data-num="4" class="blue"></div>
					<div class="brown"></div>
					<div class="dark-orange"></div>
					<div  data-num="9" class="gray"></div>
					<div class="purple"></div>
					<div data-num="10" class="black"></div>
				</div>
			</div>
    <?php }
    ...
    { ?>
				...
				<div class="list-colors-of-pugs-2">
					<div data-num="2" class="red"></div>
					<div  data-num="3" class="orange"></div>
					<div data-num="6" class="green"></div>
					<div data-num="9" class="blue"></div>
					<div data-num="12" class="brown"></div>
					<div data-num="4" class="dark-orange"></div>
					<div data-num="15" class="gray"></div>
					<div class="purple"></div>
					<div data-num="16" class="black"></div>
					<div data-num="12" class="brown"></div>
					<div class="dark-orange"></div>
					<div data-num="15" class="gray"></div>
					<div class="purple"></div>
    ...
    public function getBreadcrumbs($catalogID, $parent_sub_tree)
    {
        if ($parent_sub_tree[2][Subdivision_ID] == $catalogID) { ?>
					...
					<a itemprop="item" href="<?= $parent_sub_tree [2][Hidden_URL] ?>"><?= $parent_sub_tree [2][Subdivision_Name] ?></a>
					<meta itemprop="position" content="1"/>
			
					<a itemprop="item" href="<?= $parent_sub_tree [1][Hidden_URL] ?>"><?= $parent_sub_tree [1][Subdivision_Name] ?></a>
					...
					<a itemprop="item" href="<?= $parent_sub_tree [0][Hidden_URL] ?>"
					   content="<?= $this->car_name; ?>"><? if (strlen($this->car_name) >= 27) {
    ...
    public function getCarImage($catalogID)
    {
        ...
        if ($parent_sub_tree [2][Subdivision_ID] == $catalogID) {
            ?>
            <div>
			<img class="kovriki--new-img" src="/style/cars/<?= $this->mark_name ?>/<?= $this->car_name ?>.jpg"
        ...
        <div>
			<img class="kovriki--new-img" src="/style/cars/<?= $parent_sub_tree [2][Subdivision_Name] ?>/<?= $parent_sub_tree [1][Subdivision_Name] ?>/<?= $this->car_name ?>.jpg"
			     alt="<?= $this->mark_name ?> <?= $this->car_name ?>"
			     title="<?= $this->mark_name ?> <?= $this->car_name ?>" />
			     </div>
        <?php }
