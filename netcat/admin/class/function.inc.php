    ...
    function ClassForm($ClassID, $action, $phase, $type, $BaseClassID) {
        ...
        <table border='0' cellpadding='0' cellspacing='0' width='99%'>
            ...
            <tr>
                <td colspan='2' style='border: none;'>
                    <?php
                    nc_print_component_disable_block_markup_field($data->DisableBlockMarkup);
                    ?>
                    <br/><br/>
                </td>
            </tr>
...
##############################################
    ...
    function ActionClassComleted($type, $parentID = false) {
        ...
        $bool_fields = array(
            ...
            'IsAuxiliary', 'DisableBlockMarkup', 'IsOptimizedForMultipleMode'
        );
    ...
    function ClassInformation($ClassID, $action, $phase) {
        ...
        <script type="text/javascript">
            function refreshTree(){
                var newClassGroup = $nc("#Class_Group option:selected").attr('md5');
        ...
        ?>
            <div id='maininfoOn'>
                ...
                echo "<input type='text' name='Class_Name' size='50' value=\"" . htmlspecialchars($row->Class_Name) . "\"><br/><br/>";

                if ($row->File_Mode) {
                    echo "<div class='inf_block'><label>" . CONTROL_CLASS_CLASS_KEYWORD . ":</label><br/>";
                    echo "<input type='text' name='Keyword' size='50' maxlength='" . nc_component::MAX_KEYWORD_LENGTH . "' value=\"" . htmlspecialchars($row->Keyword) . "\"><br/><br/>";
                }

                echo "<div class='inf_block'><label>" . CONTROL_CLASS_CLASS_OBJECT_NAME_SINGULAR . ":</label><br/>";
                echo "<input type='text' name='ObjectNameSingular' size='50' value=\"" . htmlspecialchars($row->ObjectNameSingular) . "\"><br/><br/>";

                echo "<div class='inf_block'><label>" . CONTROL_CLASS_CLASS_OBJECT_NAME_PLURAL . ":</label><br/>";
                echo "<input type='text' name='ObjectNamePlural' size='50' value=\"" . htmlspecialchars($row->ObjectNamePlural) . "\"><br/><br/>";
                ...
                if (!($row->ClassTemplate || $phase == 15 || $phase == 17)) {
                    ...
                    echo "<br /><div class='inf_block'><label>" . CONTROL_CLASS_NEWGROUP . "</label><br/><input type='text' name='Class_Group_New' size='50' value='" . htmlspecialchars($row->Class_Group_New) . "'></div>";

                    // Переключатель "Служебный компонент"
                    echo "<br /><div class='nc-form-checkbox-block'><label>" .
