...
function ActionCatalogueCompleted($CatalogueID, $type) {
    ...
    if ($type == 1) {
        ...
        $insert.= "`Catalogue_Name`, `Domain`, `{$nc_core->page->get_field_name('language')}`, `Template_ID`,  `Read_Access_ID`, `Write_Access_ID`, `Edit_Access_ID`, `Checked_Access_ID`, `Delete_Access_ID`, `Subscribe_Access_ID`, `Moderation_ID`, `Checked`, `Priority`, `Created`, `Mirrors`, `Robots`, `{$lm_type}`, `TemplateSettings` , `ncOfflineText`, `ncMobile`, `ncMobileSrc`, `ncMobileRedirect`, `ncMobileIdentity`, `ncResponsive`, `ncHTTPS`, `Default_Class_ID`) ";
        $insert.= "VALUES (";
