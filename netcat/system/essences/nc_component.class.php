...
class nc_Component extends nc_Essence {
    ...
    public function create(array $properties = array(), $base_component_id = null, $parent_component_id = null) {
        ...
        foreach ($component_files as $component_file) {
            $base_component_file_path = $base_component_folder_path . '/' . $component_file . '.html';
            $component_file_path = $component_folder_path . '/' . $component_file . '.html';
    ...
    public function add($class_name, $class_group, $params, $class_template = 0, $type = 'useful') {
        ...
        $params_int = array('AllowTags', 'RecordsPerPage', 'NL2BR', 'UseCaptcha', 'CacheForUser', 'IsAuxiliary', 'IsOptimizedForMultipleMode', 'DisableBlockMarkup');
        if (!$class_template) {
