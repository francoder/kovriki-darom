...
class nc_User extends nc_Essence {
    ...
    /**
     * @param array $fields ассоциативный массив, например $fields = array('Login' => 'guest');
     * @param array|string $groups массив, список групп в которые добавить пользователя, либо строка с перечислением групп через запятую
