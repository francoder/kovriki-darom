...
$default_controller = 'information';
...
/** @var Permission $perm */
if (!(($controller_name == 'bills' || $controller_name == 'acts') && $action_name == 'print')) {
 ...
 */
$controller_class = "nc_bills_" . $controller_name . "_admin_controller";
