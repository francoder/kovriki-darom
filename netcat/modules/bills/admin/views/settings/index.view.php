...
<form action="<?= nc_module_path('bills') ?>admin/?controller=settings&action=save" method="POST" class="nc-form nc--vertical" enctype="multipart/form-data">
    ...
    <div class="nc-form-row"><label><?= NETCAT_MODULE_BILLS_SETTINGS_OPF?><br>
            ...
            <div class="nc-select">
                <select style="width:150px" name="company[opf]">
                    <? $opf = $nc_core->db->get_col('SELECT BillsClientOPF_Name FROM Classificator_BillsClientOPF;'); ?>
