...
switch ($node_type) {
    ...
    case 'module':
        $node_children = array(
          // Настройки
          array(
            "nodeId" => "services-settings",
            "parentNodeId" => $module_node_id,
            "name" => NETCAT_MODULE_SERVICES_SETTINGS,
            "href" => "#module.services.settings",
            "sprite" => "folder-dark",
            "hasChildren" => false,
            "expand" => false,
          ),
          // Яндекс.Метрика
          array(
            "nodeId" => "services-metrika",
            "parentNodeId" => $module_node_id,
            "name" => NETCAT_MODULE_SERVICES_METRIKA,
            "href" => "#module.services.metrika",
            "sprite" => "folder-dark",
            "hasChildren" => false,
            "expand" => false,
          ),          
