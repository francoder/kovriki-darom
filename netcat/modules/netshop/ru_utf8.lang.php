...
define("NETCAT_MODULE_NETSHOP_FUNCTION_IS_UNAVAILABLE", "Функция доступна в старших редакциях системы.");
...
define("NETCAT_MODULE_NETSHOP_SALES_AMOUNT",                  "Сумма продаж");
define("NETCAT_MODULE_NETSHOP_TOTAL_ORDERS",                  "Количество заказов");
define("NETCAT_MODULE_NETSHOP_COMPLETED_ORDERS",              "Выполнено заказов");
define("NETCAT_MODULE_NETSHOP_PURCHASED_GOODS",               "Продано товаров");
define("NETCAT_MODULE_NETSHOP_TOP_PURCHASED_GOODS",           "Лидеры продаж");
define("NETCAT_MODULE_NETSHOP_SUCCESSFUL_ORDERS_PERCENTAGE",  "Процент успешных заказов");
define("NETCAT_MODULE_NETSHOP_AVG_ORDER_AMOUNT",              "Средняя стоимость заказа");
define("NETCAT_MODULE_NETSHOP_AVG_SALES_ORDER_AMOUNT_BY_DAY", "Средние ежедневные продажи");
...
define("NETCAT_MODULE_NETSHOP_1C_INTEGRATION_LEGACY", "(старый обмен данными)");
...
define("NETCAT_MODULE_NETSHOP_CASHMEMO_PAYMENT", "Комиссия за прием платежа");
define("NETCAT_MODULE_NETSHOP_CASHMEMO_DELIVERY", "Доставка");
...
define("NETCAT_MODULE_NETSHOP_DELIVERY_DADATA_API_KEY", "API-ключ в сервисе dadata.ru (необходим для автоматического создания черновика заказа в Яндекс.Доставке)");
define("NETCAT_MODULE_NETSHOP_DELIVERY_YANDEX_SHIPMENT_TYPE", "Способ отгрузки");
define("NETCAT_MODULE_NETSHOP_DELIVERY_YANDEX_SHIPMENT_TYPE_IMPORT", "Самопривоз");
define("NETCAT_MODULE_NETSHOP_DELIVERY_YANDEX_SHIPMENT_TYPE_WITHDRAW", "Забор");
define("NETCAT_MODULE_NETSHOP_DELIVERY_CDEK", "СДЭК");
define("NETCAT_MODULE_NETSHOP_DELIVERY_KIT", "КИТ");
define("NETCAT_MODULE_NETSHOP_DELIVERY_CDEK_LOGIN", "Учётная запись (логин) для интеграции (не обязательно)");
define("NETCAT_MODULE_NETSHOP_DELIVERY_CDEK_PASSWORD", "Пароль (если используется учётная запись)");
define("NETCAT_MODULE_NETSHOP_DELIVERY_CDEK_SHIPMENT_TYPE", "Способ отправки");
define("NETCAT_MODULE_NETSHOP_DELIVERY_CDEK_SHIPMENT_TYPE_CDEK", "отправитель доставляет груз самостоятельно до склада СДЭК");
define("NETCAT_MODULE_NETSHOP_DELIVERY_CDEK_SHIPMENT_TYPE_SHOP", "курьер СДЭК забирает груз у отправителя");
define("NETCAT_MODULE_NETSHOP_DELIVERY_CDEK_POINT_LINK", "Подробная информация о пункте выдачи");
define("NETCAT_MODULE_NETSHOP_DELIVERY_CDEK_RATES", "Тарифы, по которым производится расчёт");
define("NETCAT_MODULE_NETSHOP_DELIVERY_CDEK_SELECTED_RATES_NUMBER_WARNING", "Использование большого числа тарифов замедлит расчёт доставки и отображение страниц оформления заказа");
define("NETCAT_MODULE_NETSHOP_DELIVERY_CDEK_REQUIRES_LOGIN", "требуется учётная запись");
...
define("NETCAT_MODULE_NETSHOP_LOCATION_IS_INVALID", "Населённый пункт с таким именем не найден. (Для городов за пределами России вначале введите название страны.)");
define("NETCAT_MODULE_NETSHOP_LOCATION_SUFFIX_PLACEHOLDER", "введите город");
...
define("NETCAT_MODULE_NETSHOP_ADMIN_NO_AVAILABLE_DELIVERY_METHODS", "Не удалось подобрать способ доставки заказа по указанному адресу");
...
define("NETCAT_MODULE_NETSHOP_DELIVERY_METHOD_SERVICE_TO_STREET", "Улица (если такое поле есть)");
define("NETCAT_MODULE_NETSHOP_DELIVERY_METHOD_SERVICE_TO_HOUSE", "Дом (если такое поле есть)");
define("NETCAT_MODULE_NETSHOP_DELIVERY_METHOD_SERVICE_TO_HOUSING", "Корпус (если такое поле есть)");
define("NETCAT_MODULE_NETSHOP_DELIVERY_METHOD_SERVICE_TO_BUILDING", "Строение (если такое поле есть)");
define("NETCAT_MODULE_NETSHOP_DELIVERY_METHOD_SERVICE_TO_FLAT", "Квартира/Офис (если такое поле есть)");
define("NETCAT_MODULE_NETSHOP_DELIVERY_METHOD_SERVICE_FULL_NAME", "Ф.И.О. клиента");
define("NETCAT_MODULE_NETSHOP_DELIVERY_METHOD_SERVICE_LAST_NAME", "Фамилия клиента (если такое поле есть)");
define("NETCAT_MODULE_NETSHOP_DELIVERY_METHOD_SERVICE_FIRST_NAME", "Имя клиента (если такое поле есть)");
define("NETCAT_MODULE_NETSHOP_DELIVERY_METHOD_SERVICE_MIDDLE_NAME", "Отчество клиента (если такое поле есть)");
...
define("NETCAT_MODULE_NETSHOP_REJECTED_ORDER_STATUS", "Статус, в который переходит заказ в случае отмены оплаты");
...
define('NETCAT_MODULE_NETSHOP_PROMOTION_COUPON_IS_REMOVED_FROM_SESSION', 'Промокод &laquo;%s&raquo; удалён');
...
define('NETCAT_MODULE_NETSHOP_EXCHANGE', 'Обмен данными');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_HAS_NO_OBJECTS', 'На выбранном сайте не настроен обмен данными! Нажмите на кнопку <b>«Добавить»</b>, чтобы запустить мастер настройки обмена.');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FAKE_FIELD_NO_FIELD', 'Не выбрано');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FAKE_FIELD_NEW_FIELD', 'Новое поле');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FAKE_FIELD_PARENT_FIELD', 'Поле, указывающее на родителя');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_TYPE_IMPORT', 'Импорт');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_TYPE_EXPORT', 'Экспорт');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_MODE_MANUAL', 'Ручной/Полуавтоматический');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_MODE_AUTOMATED', 'Автоматический');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_ERROR', 'Ошибка');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_CRITICAL_ERROR', 'Критическая ошибка');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_TYPE_CONVERSION', 'Преобразование типа');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_LIST_INSERTION', 'Добавление элемента в список');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_REPORT_HAS_BEEN_SENT', 'Отправка отчёта на Email');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_FILE_NOT_FOUND', 'Файл не найден');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_OBJECT_ADDED', 'Объект добавлен');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_OBJECT_NOT_ADDED', 'Объект не добавлен');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_OBJECT_UPDATED', 'Объект обновлен');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_OBJECT_NOT_UPDATED', 'Объект не обновлен');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ERROR_SECTION_HAS_CHILD_WITH_THIS_KEYWORD', 'У выбранного родительского раздела уже есть подраздел с таким ключевым словом!');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ERROR_HAS_COMPONENT_WITH_THIS_KEYWORD', 'Компонент с данным ключевым словом уже существует!');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ERROR_NEW_FIELD_CANT_BE_NAMED_AS', 'Название нового поля не может равняться «%s»!');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ERROR_BASE_COMPONENT_HAS_FIELDS_WITH_THIS_NAME', 'В базовом компоненте уже существуют поля с именами: %s!');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ERROR_HAS_NO_LIST_WITH_NAME', 'Такой список не существует: «%s»!');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ERROR_FIELD_IS_REQUIRED', 'Поле «%s» обязательно для заполнения!');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ERROR_FIELD_WRONG_FORMAT', 'Поле «%s» имеет неверный формат!');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ERROR_FIELD_DOES_NOT_MATCH_ANY', '«%s» не совпадает ни с один полем!');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ERROR_ATTACH_FILES_OR_SET_URL', 'Прикрепите файлы обмена или укажите URL, откуда забрать файл');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ERROR_CHOOSE_MODE', 'Выберите режим обмена!');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_WIZARD_INFO_ALREADY_HAS_FILES', 'В папке обмена уже есть ранее загруженные файлы! Они будут использоваться при настройке соответствий и для обмена.<br>Если хотите загрузить новые — прикрепите архив или укажите URL файла в форме выше.<br>Иначе оставьте поля пустыми.');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SETTINGS_FOR_OBJECT', 'Настройки для объекта');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SETTINGS_SAVED', 'Настройки сохранены!');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_RUN_WIZARD', 'Запустить мастер настройки обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_IS_PERIODICAL_RUN', 'Запускать периодически');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_PERIODICAL_RUN_FREQUENCY', 'Частота запуска обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_PERIODICAL_RUN_MINUTES', 'Минуты');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_PERIODICAL_RUN_HOURS', 'Часы');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_PERIODICAL_RUN_DAYS', 'Дни');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_IS_DOWNLOAD_REMOTE_FILE_BY_URL', 'Забирать файл или архив перед каждым обменом с заданного URL');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_REMOTE_FILE_URL', 'URL-адрес файла или архива');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_IS_SAVE_OBJECT', 'Сохранить обмен');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_IS_SEND_REPORT', 'Отправлять отчёт на Email');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_REPORT', 'Отчёт об обмене');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SEND_REPORT_WHEN', 'Когда отправлять отчет');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SEND_REPORT_ALWAYS', 'Всегда');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SEND_REPORT_ON_ERROR', 'При возникновении ошибок');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SEND_REPORT_NEVER', 'Никогда');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_OBJECT_NAME', 'Название обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_OBJECT_TYPE', 'Тип обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_OBJECT_FORMAT', 'Формат обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_OBJECT_MODE', 'Режим обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_OBJECT_EMAIL', 'Email для отправки отчётов');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_OBJECT_NOT_CONFIGURED', 'Данный обмен не настроен');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_RUNNING_EXCHANGE', 'Запуск обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_RUN_EXCHANGE', 'Запустить обмен');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FILES_IN_EXCHANGE_FOLDER', 'Файлы в папке обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FILES', 'Файлы');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_MAIN_FILES', 'Основные файлы');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_OTHER_FILES', 'Остальные файлы');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_NOT_FOUND', 'не найдены');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FILES_NOT_FOUND', 'Файлы, необходимые для обмена, не были найдены.<br> Для данного обмена необходимые файлы имеют следующие расширения: <b>%s</b>');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SHOW_ALL', 'Показать все');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_UPLOADING_FILES', 'Загрузка файлов');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SELECT_FILES', 'Выберите файлы выбранного формата или zip-архив с файлами нужного формата');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_OR_SET_FILES_URL', 'Или введите сюда URL файла');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_IS_REMOVE_OLD_FILES', 'Удалить старые файлы');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FILES_UPLOADED', 'Файлы успешно загружены');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_COMPONENT', 'Компонент');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SUBDIVISION', 'Раздел');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_INFOBLOCK', 'Инфоблок');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ALL_LOGS_HAVE_BEEN_DELETED', 'Логи успешно удалены');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_LOG', 'Лог');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_LOGS', 'Хронология обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_DATE_START', 'Дата и время начала');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_DATE_END', 'Дата и время конца');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_STATISTICS', 'Статистика обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_STATISTICS_ACTION', 'Событие');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_STATISTICS_ACTION_COUNT', 'Кол-во раз');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_LOGS_DATE_TIME', 'Дата и время');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_MSG', 'Сообщение');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FILE', 'Файл');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_LOGS_NOT_FOUND', 'Логов для данного обмена не найдено');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_WIZARD', 'Мастер настройки обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_WIZARD_CURRENT_STEP', 'Текущий шаг');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SELECT_FILE_OR_ARCHIVE', 'Выберите файл выбранного формата или zip-архив с файлами нужного формата');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_OR_SET_URL', 'Или введите сюда URL файла');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SELECTING_COMPONENT', 'Выбор компонента');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SELECT_COMPONENT_THAT_EXISTS', 'Выберите существующий компонент');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_CREATE_COMPONENT_BASED_ON_ANOTHER', 'Создать новый компонент на основе существующего');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_NEW_COMPONENT_NAME', 'Название нового компонента');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_NEW_COMPONENT_KEYWORD', 'Ключевое слово нового компонента');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SELECTING_SUBDIVISION', 'Выбор раздела');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SELECT_SUBDIVISION_THAT_EXISTS', 'Выберите существующий раздел');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_CREATE_SUBDIVISION', 'Создать новый раздел');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SELECT_PARENT_SUBDIVISION', 'Выберите родительский раздел для нового раздела');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_NEW_SUBDIVISION_NAME', 'Название нового раздела');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_NEW_SUBDIVISION_KEYWORD', 'Ключевое слово нового раздела');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_MAPPING_FIELDS', 'Соответствие полей');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FIELD_IN_COMPONENT', ' Поле в компоненте');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FIRST_STRING_IN_FILE', 'Первая строка в файле');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SECOND_STRING_IN_FILE', 'Вторая строка в файле');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_THIRD_STRING_IN_FILE', 'Третья строка в файле');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_NEW_FIELD', 'Новое поле');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_EDIT_FIELD', 'Редактирование поля');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FIELD_NAME', 'Название поля (латинскими буквами)');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FIELD_NAME_EXAMPLE', 'Например: Property_Size');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FIELD_DESCRIPTION', 'Описание поля');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FIELD_DESCRIPTION_EXAMPLE', 'Например: Размер');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FIELD_TYPE', 'Тип поля');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FIELD_FORMAT', 'Название списка (латинскими буквами)');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FIELD_FORMAT_EXAMPLE', 'Например: Region');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FIELD_SELECT_PLACEHOLDER', 'Выберите нужные поля...');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FIELD_NOT_FOUND', 'Поля по запросу не найдены');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SAVE', 'Сохранить');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_VARIANTS_FIELDS', 'Поля, отделяющие варианты товаров друг от друга');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SEARCH_FIELDS', 'Поля, по которым возможен поиск');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_VARIANTS_FIELDS_NOT_SET', 'Выбрана опция «Задать поля, отделяющие варианты товаров друг от друга», но не задано ни одно поле!');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SEARCH_FIELDS_NOT_SET', 'Выбрана опция «Задать поля, по которым возможен поиск», но не задано ни одно поле!');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_VARIANT_FIELD', 'Поле, отделяющее варианты товаров');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SEARCH_FIELD', 'Поле, отделяющее возможность поиска');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SET_THIS_FIELDS', 'Задать такие поля');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SET_THIS_FIELDS_IN_THE_END', '<b>Внимание!</b> Заполните эти поля в самом конце, после настройки соответствия полей с полями компонента!');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_PLEASE_FIX_ERROR', 'Пожалуйста, устраните ошибки');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_REQUIRED_FIELDS_NOT_MAPPED', 'Не настроены соответствия для важных полей');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SELECT_COMPONENT', 'Выберите компонент для данного типа товара');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SELECT_PARENT_COMPONENT', 'Выберите родительский компонент для данного типа товара');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_PHASE', 'Этап');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_PHASE_OUT_OF', 'из');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_GOOD', 'Товар');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_EXCHANGE_START', 'Начало обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_EXCHANGE_FINISH', 'Конец обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_TRYING_TO_LOAD_FILES_BY_URL', 'Попытка загрузить файлы по указанному URL');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FAILED_TO_LOAD_FILES_BY_URL', 'Не удалось загрузить файлы, или по указанному URL лежат неподходящие файлы');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_NOT_CONFIGURED', 'Обмен не настроен');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_EXCHANGE_FOLDER_IS_EMPTY', 'Папка обмена пуста');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FILE_NOT_FOUND', 'Файл не найден');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_START_FILE_PROCESSING', 'Начало обработки файла');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FINISH_FILE_PROCESSING', 'Конец обработки файла');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FILE_IS_EMPTY', 'Файл пуст');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_OBJECT_ADDED_TO_LIST', 'Поле "%s" (список "%s"): объект был добавлен в список [%s]');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_TYPE_CASTING_FOR_FIELD', 'Приведение типа для поля "%s": "%s" => "%s"');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FILE_HAS_NOT_BEEN_FOUND', 'Поле "%s": файл не был найден [%s]');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FILE_PATH_HAS_NOT_BEEN_FOUND', 'Поле "%s": путь к файлу не указан');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_OBJECT_HAS_BEEN_UPDATED', 'Объект был обновлён (ID: %s; %s: %s;)');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_OBJECT_HAS_NOT_BEEN_UPDATED', 'Не удалось обновить объект (ID: %s; %s: %s;)');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_OBJECT_HAS_BEEN_ADDED', 'Объект был добавлен (ID: %s; %s: %s;)');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_OBJECT_HAS_NOT_BEEN_ADDED', 'Не удалось добавить объект (%s: %s;)');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SELECT', 'Выберите');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_TYPE_PRICE', 'Цены и остатки');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ERROR_NO_GOOD_DATA_OR_COMPONENT_NOT_MAPPED', 'Для данного раздела нет данных о товарах, либо данные есть, но не настроен компонент и его поля.');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FIELD_NAME_ARTICLE', 'Артикул');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FIELD_NAME_ITEM_ID', 'Ид Товара');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FIELD_NAME_PRICE', 'Цена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FIELD_NAME_STOCK_UNITS', 'Количество на складе');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ERROR_NO_DATA_FOR_SUBDIVISION', 'Для данного раздела нет данных о товарах.');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_OBJECT_HAS_NOT_BEEN_FOUND', 'Объект не был найден ни в одном товарном компоненте (%s: %s;)');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_GO_BACK', 'Вернуться');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_SUBMIT', 'Отправить');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_NEXT', 'Далее');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_CONTINUE', 'Продолжить');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_SAVE', 'Сохранить');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_FINISH', 'Завершить');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_REMOVE', 'Удалить');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_REMOVE_SELECTED', 'Удалить выбранные');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ACTION_RUN_EXCHANGE', 'Запустить обмен');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_STEP_TYPE_AND_FORMAT', 'Формат');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_STEP_SELECTION', 'Выбор объектов для сопоставления');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_STEP_MAPPING', 'Соответствие полей');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_STEP_CML', 'Настройка автоматического обмена с 1C/МойСклад');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_STEP_FINISH', 'Завершение');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_NEW_EXCHANGE_NAME', 'Новый обмен');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_FOUND_NOT_FINISHED_OBJECT', 'Найден ненастроенный обмен');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_PLEASE_WAIT', 'Пожалуйста, подождите');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_PLEASE_WAIT_EXCHANGE_FINISH', 'Пожалуйста, подождите<br>окончания процесса обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ZIP_EXTENSION_NOT_FOUND', 'PHP-расширение LibZip не найдено! Использование архивов невозможно.');
define("NETCAT_MODULE_NETSHOP_EXCHANGE_UPLOAD_INFO", "Настройки вашего сервера:<br>
...
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SKIP_FIRST', 'Пропустить первые');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ROWS_IN_FILE', 'строк в файле');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ITEM_KEY_INFO_CSV', 'Файл <b>"%s"</b>');
...
define('NETCAT_MODULE_NETSHOP_EXCHANGE_ITEM_KEY_INFO_CML', 'Раздел <b>«%s»</b>');
...
define('NETCAT_MODULE_NETSHOP_EXCHANGE_SELECT_AT_LEAST_ONE_OBJECT_FOR_MAPPING', 'Выберите хотя бы один объект для сопоставления!');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_NOT_MAPPED', 'Не сопоставлено');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_NOTIFICATION_FOR_AUTOMATED_MODE', 'В данном режиме файлы будут загружены автоматически из 1С/МойСклад.<br>На следующем шаге вам будет предложена инструкция для настройки обмена.');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_WARNING_LARGE_FILE_SIZE', 'Размер файла <b>«%s»</b> превышает приемлемый. При обработке данного файла, вероятно, могут возникнуть проблемы.');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_AUTOMATED_HELP_STEP_1', 'Шаг 1: Создайте обмен 1C/МойСклад с сайтом, используя следующие данные');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_AUTOMATED_EXTERNAL_URL', 'URL для 1C/МойСклад');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_AUTOMATED_EXTERNAL_LOGIN', 'Логин');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_AUTOMATED_EXTERNAL_PASSWORD', 'Пароль');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_AUTOMATED_HELP_STEP_2', 'Шаг 2: Запустите обмен на стороне 1C/МойСклад вручную, дождитесь окончания выгрузки, затем убедитесь в том, что файлы появились на сайте');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_AUTOMATED_FILE_STATUS', 'Статус файлов обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_AUTOMATED_FILE_STATUS_HAS', 'Файлы есть');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_AUTOMATED_FILE_STATUS_HAS_NOT', 'Файлов пока нет');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_AUTOMATED_FILE_STATUS_REFRESH', 'Обновить статус');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_AUTOMATED_HELP_STEP_3', 'Шаг 3: Продолжите прохождение мастера настройки обмена');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_AUTOMATED_HELP_STEP_3_DETAILS_WAIT', 'Продолжить пока нельзя, т.к. файлы для импорта не были найдены.');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_AUTOMATED_HELP_STEP_3_DETAILS_CONTINUE', 'Нажмите «Далее», чтобы продолжить.');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_AUTOMATED_FILES_NOT_FOUND_PLEASE_WAIT', 'Файлы импорта не найдены! Пожалуйста, дождитесь их появления.');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_IS_AUTOMATED_MODE_ACTIVE', 'Запускать автоматический импорт при получении файлов');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_WARNINGS', 'Предупреждения');
define('NETCAT_MODULE_NETSHOP_EXCHANGE_LIMITS_WARNING', 'Настоятельно рекомендуем повысить значение характеристик <b><code>memory_limit</code></b> и <b><code>max_execution_time</code></b>.');
