...
$NETSHOP_FOLDER = __DIR__;

// основной класс
require_once "$NETSHOP_FOLDER/nc_netshop.class.php";
nc_core::get_object()->register_class_autoload_path('nc_netshop_', "$NETSHOP_FOLDER/classes");
...
// регистрация событий для статистики e-commerce
nc_netshop::register_events();
