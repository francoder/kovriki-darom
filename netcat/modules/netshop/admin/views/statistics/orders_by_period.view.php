...
<div class="nc-margin-20">
    <table class="nc-table nc--striped nc--bordered">
        ...
        <tr>
            <td><?=NETCAT_MODULE_NETSHOP_SALES_AMOUNT ?></td>
            ...
            <td><?=NETCAT_MODULE_NETSHOP_SUCCESSFUL_ORDERS_PERCENTAGE ?></td>
            ...
            <td><?=NETCAT_MODULE_NETSHOP_TOTAL_ORDERS ?></td>
            ...
            <td><?=NETCAT_MODULE_NETSHOP_AVG_ORDER_AMOUNT ?></td>
            ...
            <td><?=NETCAT_MODULE_NETSHOP_AVG_SALES_ORDER_AMOUNT_BY_DAY ?></td>
