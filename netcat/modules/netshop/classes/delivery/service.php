...
abstract class nc_netshop_delivery_service {
    ...
    protected $fields = array(
        ...
        'from_location_data', //информация о населённом пункте, nc_netshop_location_data
        ...
        'to_location_data', //информация о населённом пункте, nc_netshop_location_data
        ...
        'weight', //вес посылки
        'size1', //размер 1 (например, ширина)
        'size2', //размер 2 (например, высота)
        'size3', //размер 3 (например, глубина)
    ...
    public function set_data(array $data) {
        foreach ($data as $index => $value) {
            if (isset($this->mapped_fields[$index]) || in_array($index, $this->fields)) {
    ...
    /**
     * Возвращает пункты выдачи в указанном населенном пункте
     * (или null, если такая возможность не поддерживается)
    ...
    /**
     * Оформление заказа во внешнем ресурсе
