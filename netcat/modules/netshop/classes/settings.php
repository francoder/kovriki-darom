 ...
 *   CompanyName
 *   Address
 *   City       (до 5.8.0.17214 — идентификатор, список Region; после — строка)
 *   Phone
 *   MailFrom
 *   ManagerEmail
 *   INN
 ...
 *   RejectedOrderStatusID   статус, в который переводится заказ при отмене оплаты
 *
 ...
 *   LocationProviders — перечисление используемых классов для подбора города через запятую
 *       (например: 'nc_netshop_location_provider_russianpost, nc_netshop_location_provider_country')
 *
