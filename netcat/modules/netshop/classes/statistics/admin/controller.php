...
class nc_netshop_statistics_admin_controller extends nc_netshop_admin_controller {
    ...
    protected $chart_labels = array(
        'total_orders'                 => NETCAT_MODULE_NETSHOP_TOTAL_ORDERS,
        'completed_orders'             => NETCAT_MODULE_NETSHOP_COMPLETED_ORDERS,
        'purchased_goods'              => NETCAT_MODULE_NETSHOP_PURCHASED_GOODS,
        'sales_amount'                 => NETCAT_MODULE_NETSHOP_SALES_AMOUNT,
        'successful_orders_percentage' => NETCAT_MODULE_NETSHOP_SUCCESSFUL_ORDERS_PERCENTAGE,
    );
    ...
    **************************************************************************/
    ...
    public function action_goods($page, $limit, $order) {
        ...
        $data = array(
            ...
            'table_title'   => NETCAT_MODULE_NETSHOP_TOP_PURCHASED_GOODS,
            'table_headers' => array(
                'Name'        => NETCAT_MODULE_NETSHOP_BANK_GOODS_TITLE,
                'Qty'         => NETCAT_MODULE_NETSHOP_PURCHASED_GOODS,
                'SalesAmount' => NETCAT_MODULE_NETSHOP_SALES_AMOUNT,
            ),
    ...
    public function action_customers($page, $limit, $order) {
        ...
        $data = array(
            ...
            'table_headers' => array(
                ...
                'Email'       => '',
                'TotalOrders' => NETCAT_MODULE_NETSHOP_TOTAL_ORDERS,
                'TotalGoods'  => NETCAT_MODULE_NETSHOP_PURCHASED_GOODS,
                'TotalPrice'  => NETCAT_MODULE_NETSHOP_SALES_AMOUNT,
            ),
            'table_ordering_fields' => $valid_orders,
        );
