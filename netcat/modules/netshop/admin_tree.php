...
switch ($node_type) {
    ...
    case 'module':
        $node_children = array(
            ...
            // Обмен данными
            array(
                "nodeId" => "netshop-exchange",
                "parentNodeId" => $module_node_id,
                "name" => NETCAT_MODULE_NETSHOP_EXCHANGE,
                "href" => "#module.netshop.exchange",
                "sprite" => "database",
                "hasChildren" => false,
                "expand" => false,
            ),
            ...
            array(
                "nodeId" => "netshop-1c",
                "parentNodeId" => $module_node_id,
                "name" => NETCAT_MODULE_NETSHOP_1C_INTEGRATION . ' ' . NETCAT_MODULE_NETSHOP_1C_INTEGRATION_LEGACY,
