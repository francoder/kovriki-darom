  ...
  if ($comment_id) {
    ...
    if ($comment_edit==1) {
      ...
      try {
        ...
        //echo nl2br($comment);
        // bbcode processing
        if ($nc_comments->isBBcodes()) $commentData['Comment'] = nc_bbcode($commentData['Comment']);
...
if (isset($_POST['redirect_url']) && $nc_core->security->url_matches_local_site($_POST['redirect_url'])) {
