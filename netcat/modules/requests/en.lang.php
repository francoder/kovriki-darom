...
define("NETCAT_MODULE_REQUESTS_FORM_BUTTON_COLOR", "Color");
define("NETCAT_MODULE_REQUESTS_FORM_BUTTON_PRICE", "Show price");
...
define("NETCAT_MODULE_REQUESTS_NOTIFICATION_EMAIL_SUBJECT", "New request from %s");
