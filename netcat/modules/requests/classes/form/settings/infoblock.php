...
class nc_requests_form_settings_infoblock extends nc_record {
     ...
     */
    static public function for_infoblock($infoblock_id, $form_type) {
     ...
     * @return bool|int
     */
    static public function duplicate_settings_for_all_form_types($source_infoblock_id, $target_infoblock_id) {
     ...
     */
    static public function get_all_form_types_settings_in_infoblock($infoblock_id) {
        $infoblock_id = (int)$infoblock_id;
     ...
     * @return array
     */
    static public function get_all_form_types_settings_in_infoblock_as_array($infoblock_id) {
