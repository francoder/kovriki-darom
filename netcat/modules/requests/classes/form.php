...
class nc_requests_form {
    ...
    protected function __construct($infoblock_id, $form_type) {
        $this->site_id = nc_core::get_object()->sub_class->get_by_id($infoblock_id, 'Catalogue_ID');
        $this->subdivision_id = nc_core::get_object()->sub_class->get_by_id($infoblock_id, 'Subdivision_ID');
    ...
    protected function get_subdivision_settings() {
        return $this->subdivision_settings ?: nc_requests_form_settings_subdivision::for_subdivision($this->subdivision_id, $this->form_type);
    }
    ...
    public function get_form(array $parameters = array()) {
        ...
        $nc_component_css_class = $nc_core->component->get_css_class_name($request_component_template_id);
    ...
    protected function get_button($button_id, $settings_prefix) {
        ...
        $button =
            ...
            ($button_background_color ? " style='background-color: " . htmlspecialchars($button_background_color) . "'" : '') .
